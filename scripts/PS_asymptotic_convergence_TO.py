...
for j in range(12,13):
    ...
    for k in range(4):
        ...
        probabilityk = probabilities[mov_meani,pp,4,initialize,:]
        ...
        ax.bar(bins[1:]-bin_width/2,climatological_probabilities,width=bin_width,alpha=0.8,edgecolor='black',color='grey',label='climatological')
        ax.bar(bins[1:]-bin_width/2,pdf,width=bin_width/1.5,alpha=0.7,edgecolor='black',color='red',label= 'prediction')
