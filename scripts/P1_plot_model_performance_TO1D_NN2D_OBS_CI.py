...
loadpath = '/Users/hoffmanl/Documents/data/manuscripts/ms1/d3/performance_pval_TO1D_NN2D_OBS.nc'
dataset =  nc.Dataset(loadpath,'r')
to_cod = dataset.variables['to_cod']
to_rel = dataset.variables['to_rel']
to_cod_pval = dataset.variables['to_cod_pval']
to_rel_pval = dataset.variables['to_rel_pval']

nn_cod = dataset.variables['nn_cod']
nn_rel = dataset.variables['nn_rel']
nn_cod_pval = dataset.variables['nn_cod_pval']
nn_rel_pval = dataset.variables['nn_rel_pval']

cod_ps = dataset.variables['cod_ps']

loadpath = '/Users/hoffmanl/Documents/data/manuscripts/ms1/d3/performance_CI_TO1D_NN2D_OBS.nc'
dataset =  nc.Dataset(loadpath,'r')
...
oneyearjulyTO_rel = to_rel[6,0,0]
oneyearjulyTO_cod_CI = to_cod_CI[6,0,0,:]
oneyearjulyTO_rel_CI = to_rel_CI[6,0,0,:]
