...
loadpath = '/Users/hoffmanl/Documents/data/manuscripts/ms1/d3/performance_CI_NN1D_NN2D_OBS.nc'
dataset =  nc.Dataset(loadpath,'r')
nn1d_cod = dataset.variables['nn1d_cod']
nn1d_rel = dataset.variables['nn1d_rel']
nn1d_cod_CI  = dataset.variables['nn1d_cod_CI']
nn1d_rel_CI  = dataset.variables['nn1d_rel_CI']

nn2d_cod = dataset.variables['nn2d_cod']
nn2d_rel = dataset.variables['nn2d_rel']
nn2d_cod_CI  = dataset.variables['nn2d_cod_CI']
nn2d_rel_CI  = dataset.variables['nn2d_rel_CI']
