...
for j in range(3):
    ...
    for i in range(10):
        ...
        maskrel = ((np.round(data_rel_CI_low,2) <= 1) & (1 <= np.round(data_rel_CI_high))) & (data_corr > persistence)
    ...
    if j < 2:
        ...
        if j == 0:
            ...
            ax.scatter(Xshort[mask11[:,0:nmo]], Yshort[mask11[:,0:nmo]], s=1000,marker='^',color='seagreen',edgecolors= "black")
        ...
        if j == 0:
            ...
            ax.scatter(Xshort[mask22[:,0:nmo]], Yshort[mask22[:,0:nmo]],s=1000, marker='^', color='seagreen',edgecolors= "black")
        ...
        ax.scatter(Xshort[maskcod1[:,0:nmo]], Yshort[maskcod1[:,0:nmo]], marker='^', s=1500,color='seagreen',edgecolors= "black")
        ax.scatter(Xshort[maskcod[:,0:nmo]], Yshort[maskcod[:,0:nmo]], marker = 's', s=1500,color='black',edgecolors= "black")
        if num_elements_greater_than_two > 0:
        ...
        ax.scatter(Xshort[maskrel1[:,0:nmo]], Yshort[maskrel1[:,0:nmo]],s=1500,marker='^',color='seagreen',edgecolors= "black")
        ax.scatter(Xshort[maskrel[:,0:nmo]], Yshort[maskrel[:,0:nmo]],s=1500,marker='s', color='black',edgecolors= "black")
...
savepath = '/Users/hoffmanl/Documents/data/manuscripts/ms1/d3/performance_CI_TO1D_NN2D_PM.nc'
