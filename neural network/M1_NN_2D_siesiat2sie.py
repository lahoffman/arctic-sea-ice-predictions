...
for i in range(12):
    ...
    for j in range(10):
        ...
        for h in range(10):
            ...
            x_ics = np.concatenate((ics,zeros),axis = 1)
...
#------------------------------------------------------------
#------------------------------------------------------------
savepath = '/Users/hoffmanl/Documents/data/manuscripts/ms1/d3/NN_2D_siearea2sie_bins_ICs.nc'
...
for k in range(12):
    ...
    for i in range(10):
        ...
        for j in range(10):
            ...
            #is there data or NaN in input
            ntt = ypobs.shape[0]
            nanpadding2D = np.full((45-ntt,23),np.nan)
...
#------------------------------------------------------------
#------------------------------------------------------------
savepath = '/Users/hoffmanl/Documents/data/manuscripts/ms1/d3/NN_2D_siearea2sie_bins_performance.nc'
with nc.Dataset(savepath,'w') as file:
    #create dimensions
